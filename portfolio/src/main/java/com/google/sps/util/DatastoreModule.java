...
public class DatastoreModule {
    ...
    public static void storeContactMessage(String[] messageContents){
        ...
        Entity messageEntity = Entity.newBuilder(messageKey.newKey(messageContents[3]))
            .set("From", messageContents[0])
            .set("Email", messageContents[1])
            .set("Message", messageContents[2])
            .set("Timestamp", messageContents[3])
            .build();
    ...
    public static Boolean needsToBeRefreshed(){
        //TODO  Check to see if the access token is expired, if so, return true
        return false;
    }

    public static void refreshAccessToken(){
        //TODO: Implement a method to refresh the access token saved in Datastore
    }
