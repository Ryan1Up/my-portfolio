...
public class ContactServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws IOException {
        ...
        String messages = DatastoreModule.getMessagesAsJson();
    ...
    public void doPost(final HttpServletRequest request, final HttpServletResponse response) throws IOException {
        ...
        String[] message = parseContactMessage(request);
    ...
    private static String[] parseContactMessage(HttpServletRequest req) {
        ...
        String[] message = { name, email, msg, time };

        return message;
    }

    private static void sendEmail(final HttpServletRequest request, String[] message)
        ...
        if(DatastoreModule.needsToBeRefreshed()){
            DatastoreModule.refreshAccessToken();
        }
        
        JsonObject credentialJson = new Gson().fromJson(DatastoreModule.getCredentials(), JsonObject.class);
     ...
     */
    private static void createCredentialsAndSendMessage(JsonObject credentialJson, String[] message)
            throws GeneralSecurityException, IOException, AddressException, MessagingException {
    ...
    private static void buildCredentialsAndService(JsonObject credentialJson) throws GeneralSecurityException, IOException {
        ...
        if(creds == null || service == null){
           ...
           // tokenResponse.setAccessToken(credentialJson.get("refresh_token").toString().replaceAll("\"", ""));
            ...
            service = builder.setApplicationName(credentialJson.get("project_id").toString().replaceAll("\"", "")).build();   
        }
    }
