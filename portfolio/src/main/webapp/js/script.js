...
async function test() {
    const responseFromServer = await fetch("/api_ext");
...
async function loadContacts(){
    const responseFromServer = await fetch("/contact-storage-handler");

    const responseJson = await responseFromServer.json();
...
function createListElement(contact){
